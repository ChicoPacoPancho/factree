...
public class DestroySelfTimer : MonoBehaviour
{
    ...
    public bool setResourceSO = false;
    public GarbageSO resourceSO;
    ...
    void TimerUp()
    {
        ...
        if (setResourceSO)
        {
            FindObjectOfType<GridManagement>().cityGrid.GetGridObject(gridXY.x, gridXY.y).Resource = resourceSO;
        }
        Destroy(gameObject);
    }
